...
( 
	OARCashRecordID      uuid  NOT NULL ,
	count                char(18)  NULL ,
	5x5x5Referral        boolean  NULL ,
	DogIndication        boolean  NULL ,
	rfFinancialinstrumentID integer  NOT NULL ,
	rfCurrencyID         integer  NOT NULL ,
	amount               char(18)  NULL ,
	...
	seized               boolean  NULL ,
	partneragencyid      integer  NOT NULL 
);
...
( 
	passengerdetailsid   uuid  NOT NULL ,
	surname              char(18)  NULL ,
	forename             char(18)  NULL ,
	othernames           char(18)  NULL ,
	DOB                  date  NULL ,
	UKresident           boolean  NULL ,
	forgery              boolean  NULL ,
	egatesintercept      boolean  NULL ,
	genderid             integer  NOT NULL ,
	countryid            character varying(2)  NOT NULL ,
	nationalityid        integer  NOT NULL ,
	ctreferraleventid    uuid  NOT NULL 
);
...
( 
	...
	illicitgoodid        uuid  NOT NULL ,
	feedbackoutcomeid    integer  NOT NULL 
);
...
( 
	fastparcelsandpostid uuid  NOT NULL ,
	consignorid          uuid  NOT NULL ,
	consigneeid          uuid  NOT NULL ,
	ctreferraleventid    uuid  NOT NULL 
);
...
( 
	OARgradecountid      uuid  NOT NULL ,
	NumberofHOs          integer  NULL ,
	NumberofOs           integer  NULL ,
	NumberofAOs          integer  NULL ,
	NumberofSeasonalWorkers integer  NULL ,
	TotalNumberofPermanentStaff integer  NULL ,
	TotalNumberofStaff   integer  NULL ,
	TotalHoursWorkedHOs  integer  NULL ,
	TotalHoursworkedOs   integer  NULL ,
	TotalHoursWorkedAOs  integer  NULL ,
	TotalHoursWorkedSeasonal integer  NULL ,
	TotalShiftHours      integer  NULL 
);
...
( 
	ctreferraleventid    uuid  NOT NULL ,
	maritimecontainerid  uuid  NOT NULL ,
	continaernumber      char(18)  NULL ,
	arrivaldate          date  NULL ,
	cargodescrition      char(18)  NULL ,
	carrierlistid        uuid  NOT NULL ,
	countryid            character varying(2)  NOT NULL ,
	consignorid          uuid  NOT NULL ,
	consigneeid          uuid  NOT NULL 
);
...
( 
	OARPerformanceatBorderID uuid  NOT NULL ,
	searchexaminationtypeid integer  NOT NULL ,
	rftargetcatid        char(18)  NOT NULL ,
	rfsearchcatid        char(18)  NOT NULL ,
	EC_Positive_Count    integer  NULL ,
	EC_Negative_Count    integer  NULL ,
	3C_Positive_Count    integer  NULL ,
	3C_Negative_Count    integer  NULL ,
	Chief_Self_Generated integer  NULL ,
	NCH_Abandonded       integer  NULL ,
	NCH_Strategic        integer  NULL ,
	NCH_Other            integer  NULL ,
	NCTS_Exam            integer  NULL 
);
...
( 
	OARrecordID          uuid  NOT NULL ,
	OARgradecountid      uuid  NOT NULL ,
	OARStaffUtilsationID uuid  NOT NULL ,
	OARPerformanceatBorderID uuid  NOT NULL ,
	OARCashRecordID      uuid  NOT NULL ,
...
CREATE TABLE rf_carrierlist
( 
	carrierlistid        uuid  NOT NULL ,
	carriername          char varying(60)  NOT NULL ,
	twolettercode        char(2)  NULL ,
	designator           integer  NULL ,
	alliance             char varying(60)  NULL ,
	aviation             boolean  NULL ,
	maritime             boolean  NULL 
);

ALTER TABLE rf_carrierlist
	ADD CONSTRAINT XPKrf_carrier PRIMARY KEY (carrierlistid);
...
CREATE TABLE rf_ctindicators
( 
	ctindicatorsid       uuid  NOT NULL ,
	ctindicator          char varying(200)  NULL 
);

ALTER TABLE rf_ctindicators
	ADD CONSTRAINT XPKrf_indicators PRIMARY KEY (ctindicatorsid);

CREATE TABLE rf_currency
( 
	rfCurrencyID         integer  NOT NULL ,
	countryid            char varying(2)  NOT NULL ,
	currency             char varying(50)  NOT NULL ,
	currencycode         char varying(3)  NOT NULL 
);

ALTER TABLE rf_currency
	ADD CONSTRAINT XPKrf_Currency PRIMARY KEY (rfCurrencyID);

CREATE TABLE rf_feedbackoutcome
( 
	feedbackoutcomeid    integer  NOT NULL ,
	feedbackoutcome      char varying(60)  NULL 
);

ALTER TABLE rf_feedbackoutcome
	ADD CONSTRAINT XPKrf_outcome PRIMARY KEY (feedbackoutcomeid);

CREATE TABLE rf_financial_instrument_type
( 
	rfFinancialinstrumentID integer  NOT NULL ,
	typeoffinanacialinstrument char varying(50)  NOT NULL ,
	description          char varying(50)  NULL 
);
...
CREATE TABLE rf_illicitgood
( 
	illicitgoodid        uuid  NOT NULL ,
	highlevelillicitgood char varying(60)  NOT NULL ,
	lowlevelillicitgood  char varying(60)  NULL ,
	controlstrategypriority char(1)  NULL ,
	description          char varying(600)  NULL 
);

ALTER TABLE rf_illicitgood
	ADD CONSTRAINT XPKrf_deteteditems PRIMARY KEY (illicitgoodid);
...
( 
	partneragencyid      integer  NOT NULL ,
	partneragencyname    char varying(50)  NOT NULL ,
	partneragencyabbreviatedname char varying(50)  NOT NULL ,
	seizure              boolean  NOT NULL ,
	disclosure           boolean  NOT NULL ,
	intellligence        boolean  NOT NULL ,
...
CREATE TABLE rf_searchexaminationtype
( 
	searchexaminationtypeid integer  NOT NULL ,
	searchexaminationtypename char varying(50)  NOT NULL ,
	usedonobject         boolean  NOT NULL ,
	usedonhuman          boolean  NOT NULL ,
	examination          boolean  NOT NULL ,
	searchofperson       boolean  NOT NULL 
);

ALTER TABLE rf_searchexaminationtype
	ADD CONSTRAINT XPKrf_examinationtype PRIMARY KEY (searchexaminationtypeid);
...
( 
	email    COLLATE pg_catalog.Collation_8050 ASC
);
...
ALTER TABLE oar_ct_referral_event
	ADD CONSTRAINT R_120 FOREIGN KEY (ctindicatorsid) REFERENCES rf_ctindicators(ctindicatorsid)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION;
...
ALTER TABLE oar_detection_details
	ADD CONSTRAINT R_143 FOREIGN KEY (illicitgoodid) REFERENCES rf_illicitgood(illicitgoodid)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION;

ALTER TABLE oar_detection_details
	ADD CONSTRAINT R_144 FOREIGN KEY (feedbackoutcomeid) REFERENCES rf_feedbackoutcome(feedbackoutcomeid)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION;
...
ALTER TABLE oar_maritime_container_details
	ADD CONSTRAINT R_135 FOREIGN KEY (carrierlistid) REFERENCES rf_carrierlist(carrierlistid)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION;
...
ALTER TABLE OAR_Performance_at_Border
	ADD CONSTRAINT R_111 FOREIGN KEY (searchexaminationtypeid) REFERENCES rf_searchexaminationtype(searchexaminationtypeid)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION;
...
ALTER TABLE oar_travel_details
	ADD CONSTRAINT R_126 FOREIGN KEY (carrierlistid) REFERENCES rf_carrierlist(carrierlistid)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION;
...
BEGIN
    /* erwin Builtin Trigger */
    /* rf_ctindicators  oar_ct_referral_event on child insert restrict */
    /* ERWIN_RELATION CHECKSUM="0004a869", PARENT_OWNER="", PARENT_TABLE="rf_ctindicators"
    CHILD_OWNER="", CHILD_TABLE="oar_ct_referral_event"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_120", FK_COLUMNS="ctindicatorsid" */
    SELECT count(*) INTO NUMROWS
      FROM rf_ctindicators
      WHERE
        /* %JoinFKPK( %New,rf_ctindicators," = "," AND") */
         new.ctindicatorsid = rf_ctindicators.ctindicatorsid;
    IF (
      /* %NotnullFK( %New," IS NOT NULL AND") */
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert oar_ct_referral_event because rf_ctindicators does not exist.'
      );
    END IF;
...
BEGIN
  ...
  /* ERWIN_RELATION CHECKSUM="000bb10b", PARENT_OWNER="", PARENT_TABLE="oar_ct_referral_event"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_134", FK_COLUMNS="ctreferraleventid" */
  IF
...
RAISE EXCEPTION 'Cannot update oar_ct_referral_event because oar_detection_details exists.';
   ...
   * erwin Builtin Trigger * 
   * rf_ctindicators  oar_ct_referral_event on child update restrict * 
   * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_ctindicators"
    CHILD_OWNER="", CHILD_TABLE="oar_ct_referral_event"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_120", FK_COLUMNS="ctindicatorsid" * 
  SELECT count(*) INTO NUMROWS
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update oar_ct_referral_event because rf_ctindicators does not exist.'
    );
  END IF;
...
BEGIN
    /* erwin Builtin Trigger */
    /* rf_feedbackoutcome  oar_detection_details on child insert restrict */
    /* ERWIN_RELATION CHECKSUM="0003920b", PARENT_OWNER="", PARENT_TABLE="rf_feedbackoutcome"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_144", FK_COLUMNS="feedbackoutcomeid" */
    SELECT count(*) INTO NUMROWS
      FROM rf_feedbackoutcome
      WHERE
        /* %JoinFKPK( %New,rf_feedbackoutcome," = "," AND") */
         new.feedbackoutcomeid = rf_feedbackoutcome.feedbackoutcomeid;
    IF (
      /* %NotnullFK( %New," IS NOT NULL AND") */
    ...
    THEN
RAISE EXCEPTION 'Cannot insert oar_detection_details because rf_feedbackoutcome does not exist.';
    END IF;

     * erwin Builtin Trigger * 
     * rf_illicitgood  oar_detection_details on child insert restrict * 
     * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_illicitgood"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_143", FK_COLUMNS="illicitgoodid" * 
    SELECT count(*) INTO NUMROWS
      FROM rf_illicitgood
      WHERE
         * %JoinFKPK( %New,rf_illicitgood," = "," AND") * 
         new.illicitgoodid = rf_illicitgood.illicitgoodid;
    IF (
       * %NotnullFK( %New," IS NOT NULL AND") * 
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert oar_detection_details because rf_illicitgood does not exist.'
      );
    END IF;
...
BEGIN
  /* erwin Builtin Trigger */
  /* rf_feedbackoutcome  oar_detection_details on child update restrict */
  /* ERWIN_RELATION CHECKSUM="00038913", PARENT_OWNER="", PARENT_TABLE="rf_feedbackoutcome"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_144", FK_COLUMNS="feedbackoutcomeid" */
  SELECT count(*) INTO NUMROWS
  ...
  THEN
RAISE EXCEPTION 'Cannot update oar_detection_details because rf_feedbackoutcome does not exist.';
  END IF;

   * erwin Builtin Trigger * 
   * rf_illicitgood  oar_detection_details on child update restrict * 
   * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_illicitgood"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_143", FK_COLUMNS="illicitgoodid" * 
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update oar_detection_details because rf_illicitgood does not exist.'
    );
  END IF;
...
BEGIN
    ...
    /* ERWIN_RELATION CHECKSUM="0006094e", PARENT_OWNER="", PARENT_TABLE="oar_consignee"
    CHILD_OWNER="", CHILD_TABLE="oar_maritime_container_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_138", FK_COLUMNS="consigneeid" */
    SELECT count(*) INTO NUMROWS
...
RAISE EXCEPTION 'Cannot insert oar_maritime_container_details because oar_consignee does not exist.';
     ...
     * erwin Builtin Trigger * 
     * rf_carrierlist  oar_maritime_container_details on child insert restrict * 
     * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_maritime_container_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_135", FK_COLUMNS="carrierlistid" * 
    SELECT count(*) INTO NUMROWS
      FROM rf_carrierlist
      WHERE
         * %JoinFKPK( %New,rf_carrierlist," = "," AND") * 
         new.carrierlistid = rf_carrierlist.carrierlistid;
    IF (
       * %NotnullFK( %New," IS NOT NULL AND") * 
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert oar_maritime_container_details because rf_carrierlist does not exist.'
      );
    END IF;
...
BEGIN
  ...
  /* ERWIN_RELATION CHECKSUM="0005ef02", PARENT_OWNER="", PARENT_TABLE="oar_consignee"
    CHILD_OWNER="", CHILD_TABLE="oar_maritime_container_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_138", FK_COLUMNS="consigneeid" */
  SELECT count(*) INTO NUMROWS
...
RAISE EXCEPTION 'Cannot update oar_maritime_container_details because oar_consignee does not exist.';
   ...
   * erwin Builtin Trigger * 
   * rf_carrierlist  oar_maritime_container_details on child update restrict * 
   * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_maritime_container_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_135", FK_COLUMNS="carrierlistid" * 
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update oar_maritime_container_details because rf_carrierlist does not exist.'
    );
  END IF;
...
BEGIN
    ...
    /* ERWIN_RELATION CHECKSUM="0003ae49", PARENT_OWNER="", PARENT_TABLE="rf_searchcountcat"
...
BEGIN
     ...
     * erwin Builtin Trigger * 
     * rf_searchexaminationtype  OAR_Performance_at_Border on child insert restrict * 
     * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_searchexaminationtype"
    CHILD_OWNER="", CHILD_TABLE="OAR_Performance_at_Border"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_111", FK_COLUMNS="searchexaminationtypeid" * 
    SELECT count(*) INTO NUMROWS
      FROM rf_searchexaminationtype
      WHERE
         * %JoinFKPK( %New,rf_searchexaminationtype," = "," AND") * 
         new.searchexaminationtypeid = rf_searchexaminationtype.searchexaminationtypeid;
    IF (
       * %NotnullFK( %New," IS NOT NULL AND") * 
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert OAR_Performance_at_Border because rf_searchexaminationtype does not exist.'
      );
    END IF;
...
BEGIN
  ...
  /* ERWIN_RELATION CHECKSUM="00051775", PARENT_OWNER="", PARENT_TABLE="OAR_Performance_at_Border"
    CHILD_OWNER="", CHILD_TABLE="OAR_Records"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_108", FK_COLUMNS="OARPerformanceatBorderID" */
  IF
...
RAISE EXCEPTION 'Cannot update OAR_Performance_at_Border because OAR_Records exists.';
   ...
   * erwin Builtin Trigger * 
   * rf_searchexaminationtype  OAR_Performance_at_Border on child update restrict * 
   * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_searchexaminationtype"
    CHILD_OWNER="", CHILD_TABLE="OAR_Performance_at_Border"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_111", FK_COLUMNS="searchexaminationtypeid" * 
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update OAR_Performance_at_Border because rf_searchexaminationtype does not exist.'
    );
  END IF;
...
BEGIN
    ...
    /* ERWIN_RELATION CHECKSUM="00046c13", PARENT_OWNER="", PARENT_TABLE="oar_ct_passenger_details"
    CHILD_OWNER="", CHILD_TABLE="oar_travel_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_130", FK_COLUMNS="passengerdetailsid" */
    SELECT count(*) INTO NUMROWS
...
RAISE EXCEPTION 'Cannot insert oar_travel_details because oar_ct_passenger_details does not exist.';
     ...
     * erwin Builtin Trigger * 
     * rf_carrierlist  oar_travel_details on child insert restrict * 
     * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_travel_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_126", FK_COLUMNS="carrierlistid" * 
    SELECT count(*) INTO NUMROWS
      FROM rf_carrierlist
      WHERE
         * %JoinFKPK( %New,rf_carrierlist," = "," AND") * 
    ...
    THEN
      raise_application_error(
        -20002,
        'Cannot insert oar_travel_details because rf_carrierlist does not exist.'
      );
    END IF;
...
BEGIN
  ...
  /* ERWIN_RELATION CHECKSUM="00047a85", PARENT_OWNER="", PARENT_TABLE="oar_ct_passenger_details"
    CHILD_OWNER="", CHILD_TABLE="oar_travel_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_130", FK_COLUMNS="passengerdetailsid" */
  SELECT count(*) INTO NUMROWS
...
RAISE EXCEPTION 'Cannot update oar_travel_details because oar_ct_passenger_details does not exist.';
   ...
   * erwin Builtin Trigger * 
   * rf_carrierlist  oar_travel_details on child update restrict * 
   * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_travel_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_126", FK_COLUMNS="carrierlistid" * 
  ...
  THEN
    raise_application_error(
      -20007,
      'Cannot update oar_travel_details because rf_carrierlist does not exist.'
    );
  END IF;
...
CREATE OR REPLACE FUNCTION aft_delete_tD_rf_carrierlist() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
    /* erwin Builtin Trigger */
    /* rf_carrierlist  oar_maritime_container_details on parent delete restrict */
    /* ERWIN_RELATION CHECKSUM="00022d43", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_maritime_container_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_135", FK_COLUMNS="carrierlistid" */
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
        /*  %JoinFKPK(oar_maritime_container_details, %Old," = "," AND") */
        oar_maritime_container_details.carrierlistid =  old.carrierlistid;
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot delete rf_carrierlist because oar_maritime_container_details exists.';
    END IF;

     * erwin Builtin Trigger * 
     * rf_carrierlist  oar_travel_details on parent delete restrict * 
     * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_travel_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_126", FK_COLUMNS="carrierlistid" * 
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
         *  %JoinFKPK(oar_travel_details, %Old," = "," AND") * 
        oar_travel_details.carrierlistid =  old.carrierlistid;
    IF (NUMROWS > 0)
    THEN
      raise_application_error(
        -20001,
        'Cannot delete rf_carrierlist because oar_travel_details exists.'
      );
    END IF;
...
CREATE  TRIGGER  tD_rf_carrierlist AFTER DELETE ON public."rf_carrierlist" for each row
EXECUTE PROCEDURE aft_delete_tD_rf_carrierlist();


CREATE OR REPLACE FUNCTION aft_update_U_rf_carrierlist() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
  /* erwin Builtin Trigger */
  /* rf_carrierlist  oar_maritime_container_details on parent update restrict */
  /* ERWIN_RELATION CHECKSUM="00027fb4", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_maritime_container_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_135", FK_COLUMNS="carrierlistid" */
  IF
    /* %JoinPKPK( %Old, %New," <> "," OR ") */
     old.carrierlistid <>  new.carrierlistid
  THEN
    SELECT count(*) INTO NUMROWS
      FROM oar_maritime_container_details
      WHERE
    ...
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot update rf_carrierlist because oar_maritime_container_details exists.';
    END IF;
  END IF;

   * erwin Builtin Trigger * 
   * rf_carrierlist  oar_travel_details on parent update restrict * 
   * ERWIN_RELATION CHECKSUM="00000000", PARENT_OWNER="", PARENT_TABLE="rf_carrierlist"
    CHILD_OWNER="", CHILD_TABLE="oar_travel_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_126", FK_COLUMNS="carrierlistid" * 
  ...
  THEN
    ...
    THEN 
      raise_application_error(
        -20005,
        'Cannot update rf_carrierlist because oar_travel_details exists.'
      );
    END IF;
  END IF;
...
CREATE  TRIGGER tU_rf_carrierlist AFTER UPDATE ON public."rf_carrierlist" for each row
EXECUTE PROCEDURE aft_update_U_rf_carrierlist();
...
CREATE OR REPLACE FUNCTION aft_delete_tD_rf_ctindicators() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
    /* erwin Builtin Trigger */
    /* rf_ctindicators  oar_ct_referral_event on parent delete restrict */
    /* ERWIN_RELATION CHECKSUM="0001094b", PARENT_OWNER="", PARENT_TABLE="rf_ctindicators"
    CHILD_OWNER="", CHILD_TABLE="oar_ct_referral_event"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_120", FK_COLUMNS="ctindicatorsid" */
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
        ...
        oar_ct_referral_event.ctindicatorsid =  old.ctindicatorsid;
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot delete rf_ctindicators because oar_ct_referral_event exists.';
    END IF;
...
CREATE  TRIGGER  tD_rf_ctindicators AFTER DELETE ON public."rf_ctindicators" for each row
EXECUTE PROCEDURE aft_delete_tD_rf_ctindicators();


CREATE OR REPLACE FUNCTION aft_update_U_rf_ctindicators() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
  /* erwin Builtin Trigger */
  /* rf_ctindicators  oar_ct_referral_event on parent update restrict */
  /* ERWIN_RELATION CHECKSUM="00013cd2", PARENT_OWNER="", PARENT_TABLE="rf_ctindicators"
    CHILD_OWNER="", CHILD_TABLE="oar_ct_referral_event"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_120", FK_COLUMNS="ctindicatorsid" */
  IF
    /* %JoinPKPK( %Old, %New," <> "," OR ") */
     old.ctindicatorsid <>  new.ctindicatorsid
  THEN
    SELECT count(*) INTO NUMROWS
      FROM oar_ct_referral_event
      WHERE
    ...
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot update rf_ctindicators because oar_ct_referral_event exists.';
    END IF;
  END IF;
...
CREATE  TRIGGER tU_rf_ctindicators AFTER UPDATE ON public."rf_ctindicators" for each row
EXECUTE PROCEDURE aft_update_U_rf_ctindicators();
...
CREATE OR REPLACE FUNCTION aft_delete_tD_rf_feedbackoutcome() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
    /* erwin Builtin Trigger */
    /* rf_feedbackoutcome  oar_detection_details on parent delete restrict */
    /* ERWIN_RELATION CHECKSUM="00010e6e", PARENT_OWNER="", PARENT_TABLE="rf_feedbackoutcome"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_144", FK_COLUMNS="feedbackoutcomeid" */
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
        /*  %JoinFKPK(oar_detection_details, %Old," = "," AND") */
        oar_detection_details.feedbackoutcomeid =  old.feedbackoutcomeid;
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot delete rf_feedbackoutcome because oar_detection_details exists.';
    END IF;
...
CREATE  TRIGGER  tD_rf_feedbackoutcome AFTER DELETE ON public."rf_feedbackoutcome" for each row
EXECUTE PROCEDURE aft_delete_tD_rf_feedbackoutcome();


CREATE OR REPLACE FUNCTION aft_update_U_rf_feedbackoutcome() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
  /* erwin Builtin Trigger */
  /* rf_feedbackoutcome  oar_detection_details on parent update restrict */
  /* ERWIN_RELATION CHECKSUM="000148b4", PARENT_OWNER="", PARENT_TABLE="rf_feedbackoutcome"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_144", FK_COLUMNS="feedbackoutcomeid" */
  IF
    /* %JoinPKPK( %Old, %New," <> "," OR ") */
     old.feedbackoutcomeid <>  new.feedbackoutcomeid
  THEN
    SELECT count(*) INTO NUMROWS
      FROM oar_detection_details
      WHERE
    ...
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot update rf_feedbackoutcome because oar_detection_details exists.';
    END IF;
  END IF;
...
CREATE  TRIGGER tU_rf_feedbackoutcome AFTER UPDATE ON public."rf_feedbackoutcome" for each row
EXECUTE PROCEDURE aft_update_U_rf_feedbackoutcome();
...
CREATE OR REPLACE FUNCTION aft_delete_tD_rf_illicitgood() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
    /* erwin Builtin Trigger */
    /* rf_illicitgood  oar_detection_details on parent delete restrict */
    /* ERWIN_RELATION CHECKSUM="00010733", PARENT_OWNER="", PARENT_TABLE="rf_illicitgood"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_143", FK_COLUMNS="illicitgoodid" */
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
        /*  %JoinFKPK(oar_detection_details, %Old," = "," AND") */
        oar_detection_details.illicitgoodid =  old.illicitgoodid;
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot delete rf_illicitgood because oar_detection_details exists.';
    END IF;
...
CREATE  TRIGGER  tD_rf_illicitgood AFTER DELETE ON public."rf_illicitgood" for each row
EXECUTE PROCEDURE aft_delete_tD_rf_illicitgood();


CREATE OR REPLACE FUNCTION aft_update_U_rf_illicitgood() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
  /* erwin Builtin Trigger */
  /* rf_illicitgood  oar_detection_details on parent update restrict */
  /* ERWIN_RELATION CHECKSUM="0001293b", PARENT_OWNER="", PARENT_TABLE="rf_illicitgood"
    CHILD_OWNER="", CHILD_TABLE="oar_detection_details"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_143", FK_COLUMNS="illicitgoodid" */
  IF
    /* %JoinPKPK( %Old, %New," <> "," OR ") */
     old.illicitgoodid <>  new.illicitgoodid
  THEN
    SELECT count(*) INTO NUMROWS
      FROM oar_detection_details
      WHERE
    ...
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot update rf_illicitgood because oar_detection_details exists.';
    END IF;
  END IF;
...
CREATE  TRIGGER tU_rf_illicitgood AFTER UPDATE ON public."rf_illicitgood" for each row
EXECUTE PROCEDURE aft_update_U_rf_illicitgood();
...
CREATE OR REPLACE FUNCTION aft_delete_tD_rf_searchexaminationtype() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
    /* erwin Builtin Trigger */
    /* rf_searchexaminationtype  OAR_Performance_at_Border on parent delete restrict */
    /* ERWIN_RELATION CHECKSUM="00012f8f", PARENT_OWNER="", PARENT_TABLE="rf_searchexaminationtype"
    CHILD_OWNER="", CHILD_TABLE="OAR_Performance_at_Border"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_111", FK_COLUMNS="searchexaminationtypeid" */
    SELECT count(*) INTO NUMROWS
      ...
      WHERE
        /*  %JoinFKPK(OAR_Performance_at_Border, %Old," = "," AND") */
        OAR_Performance_at_Border.searchexaminationtypeid =  old.searchexaminationtypeid;
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot delete rf_searchexaminationtype because OAR_Performance_at_Border exists.';
    END IF;
...
CREATE  TRIGGER  tD_rf_searchexaminationtype AFTER DELETE ON public."rf_searchexaminationtype" for each row
EXECUTE PROCEDURE aft_delete_tD_rf_searchexaminationtype();


CREATE OR REPLACE FUNCTION aft_update_U_rf_searchexaminationtype() 
RETURNS trigger AS
$$
DECLARE NUMROWS INTEGER;
BEGIN
  /* erwin Builtin Trigger */
  /* rf_searchexaminationtype  OAR_Performance_at_Border on parent update restrict */
  /* ERWIN_RELATION CHECKSUM="00015cb1", PARENT_OWNER="", PARENT_TABLE="rf_searchexaminationtype"
    CHILD_OWNER="", CHILD_TABLE="OAR_Performance_at_Border"
    P2C_VERB_PHRASE="", C2P_VERB_PHRASE="", 
    FK_CONSTRAINT="R_111", FK_COLUMNS="searchexaminationtypeid" */
  IF
    /* %JoinPKPK( %Old, %New," <> "," OR ") */
     old.searchexaminationtypeid <>  new.searchexaminationtypeid
  THEN
    SELECT count(*) INTO NUMROWS
      FROM OAR_Performance_at_Border
      WHERE
    ...
    IF (NUMROWS > 0)
    THEN
RAISE EXCEPTION 'Cannot update rf_searchexaminationtype because OAR_Performance_at_Border exists.';
    END IF;
  END IF;
...
CREATE  TRIGGER tU_rf_searchexaminationtype AFTER UPDATE ON public."rf_searchexaminationtype" for each row
EXECUTE PROCEDURE aft_update_U_rf_searchexaminationtype();
